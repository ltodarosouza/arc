# Auditoria - Álgebra Linear, lote 02

Unidade: **Espaços vetoriais**. Total: **18 questões autorais**. Distribuição: **6 fáceis, 6 médias e 6 difíceis**.
...
|   2 | Combinações lineares e conjuntos geradores | easy        | encontrar coeficientes de combinação linear         | decomposição de vetor           | usar os coeficientes como coordenadas usuais        |
...
- Subespaços vetoriais: 4
- Combinações lineares e conjuntos geradores: 2
- Dependência e independência linear: 3
- Bases e dimensão: 4
- Espaços linha, coluna e nulo: 3
- Somas e somas diretas: 2
- Tipos de comando: classificação por propriedade, decomposição de vetor, identificação de contraexemplo, verificação estrutural, leitura de representação, seleção de colunas pivô, análise de fechamento, resolução de representação, análise paramétrica, escolha de complemento, dedução por dimensão, uso de fórmula dimensional, reconstrução de espaço, análise de condição funcional, projeto de decomposição, dedução ortogonal, argumento conceitual, análise de estrutura de solução.
