...
const byTopic = {
  partes: {
    prepare:
      'Separe os fatores do produto e identifique qual deles simplifica ao ser derivado.',
    method:
  ...
  fracoes: {
    prepare:
      'Compare os graus do numerador e do denominador antes de escolher a decomposição.',
    method:
  ...
  trigonometricas: {
    prepare:
      'Observe as potências e os fatores trigonométricos presentes antes de aplicar uma identidade.',
    method:
  ...
  infinitos: {
    prepare:
      'Identifique qual extremo é infinito e reescreva a integral como um limite.',
    method:
  ...
  descontinuidades: {
    prepare:
      'Encontre primeiro os pontos internos em que a expressão não está definida.',
    method:
  ...
  'limites-sequencias': {
    prepare:
      'Localize os termos de maior crescimento no numerador e no denominador.',
    method:
  ...
  monotonicidade: {
    prepare:
      'Escreva os termos consecutivos que serão comparados e indique o domínio do índice.',
    method:
  ...
  geometricas: {
    prepare:
      'Escreva explicitamente o primeiro termo e a razão entre dois termos consecutivos.',
    method:
  ...
  convergencia: {
    prepare:
      'Isole o termo geral da série para decidir qual teste pode ser aplicado.',
    method:
  ...
  testes: {
    prepare:
      'Classifique o formato do termo geral antes de iniciar qualquer simplificação.',
    method:
  ...
  alternadas: {
    prepare:
      'Separe o sinal alternado do módulo do termo para estudar as duas partes com clareza.',
    method:
  ...
  potencias: {
    prepare:
      'Destaque a variável que aparece elevada a potências e os coeficientes que a acompanham.',
    method:
  ...
  taylor: {
    prepare:
      'Registre o centro da aproximação e as ordens que serão necessárias antes de calcular derivadas.',
    method:
...
export function enrichEditorial(item) {
  ...
  return {
    ...
    solutionSteps: [
      { title: 'Prepare a leitura', content: profile.prepare },
      { title: 'Escolha o método', content: profile.method },
      { title: 'Planeje o cálculo', content: profile.hints[0] },
      ...coreSteps,
