...
begin
  ...
  if exists(select 1 from public.questions q where q.source_id between
    ...
    and (q.publication_status<>'draft'
  ...
  then raise exception 'Incomplete draft or unintended publication'; end if;
end $$;
set local role anon;
do $$
begin
  if exists(select 1 from public.questions where source_id between
    '10000000-0000-4000-8000-000000000062' and '10000000-0000-4000-8000-000000000068')
  then raise exception 'Unreviewed draft leaked to public catalogue'; end if;
end $$;
rollback;
